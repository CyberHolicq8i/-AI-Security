# 🗺️🤖 My Agentic AI Security Roadmap (خارطة طريقي لأمن الذكاء الاصطناعي الوكيل)

## What This Is (ما هو هذا الملف)

I came across a roadmap graphic for getting into Agentic AI Security and it matched almost exactly what I'm already trying to build toward with this repo and my [GRC & AI Governance portfolio](https://github.com/CyberHolicq8i/grc-ai-governance-portfolio). So instead of just saving the image, I rewrote it as my own study roadmap — in my own words, mapped to what I've already learned (see [`01-Prompt-Injection-and-RAG-Security.md`](01-Prompt-Injection-and-RAG-Security.md)), and translated into Arabic since that's the language I think through some of this in first.
...
## 🕸️ Phase 3 — Agent Architecture (بنية الوكلاء)
...
## 🛡️🤖 Phase 4 — LLM Security (أمن النماذج اللغوية الكبيرة)

Before agent security, LLM security has to be understood on its own terms — this is the phase [`01-Prompt-Injection-and-RAG-Security.md`](01-Prompt-Injection-and-RAG-Security.md) already lives in:
...
## 🗡️ Phase 6 — Agent Red Teaming (الاختبار الهجومي للوكلاء)
...
## 🛡️ Phase 7 — Agent Defense (الدفاع عن الوكلاء)
...
## 🏗️ Phase 8 — Agent Security Engineering (هندسة أمن الوكلاء)
...
## ⚖️ Phase 10 — Governance & Risk (الحوكمة والمخاطر)
...
The pattern that keeps showing up across every phase of this roadmap is the same one from [`01-Prompt-Injection-and-RAG-Security.md`](01-Prompt-Injection-and-RAG-Security.md): AI security is never just "secure the model." It's classical cybersecurity fundamentals, applied to a pipeline that now includes retrieval, memory, tool calls, and autonomous action — plus a governance layer on top to answer for it when something goes wrong.
